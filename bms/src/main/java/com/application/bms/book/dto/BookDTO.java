package com.application.bms.book.dto;
...
public class BookDTO {
	...
	public String toString() {
		return "BookDTO [bookCd=" + bookCd + ", bookNm=" + bookNm + ", writer=" + writer + ", price=" + price
				...
				+ ", point=" + point + ", totalPage=" + totalPage + ", isbn=" + isbn + ", deliveryPrice="
				+ deliveryPrice + ", part=" + part + ", writerIntro=" + writerIntro + ", contentsOrder=" + contentsOrder
				+ ", intro=" + intro + ", publisherComment=" + publisherComment + ", recommendation=" + recommendation
				+ ", imgNm=" + imgNm + "]";
	}
